...
<article>
  ...
  <a role="button" class="mb-1" target="_blank" rel="noreferrer" href="https://{ $network === 'testnet' ? 'testnet.' : ''}flowview.app/account/{account}">Inspect account on FlowView.app</a>
  <div class="mb-1"> 
